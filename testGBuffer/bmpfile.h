...
bmpfile_t *bmp_create_mw(bmp_uint32_t width, bmp_uint32_t height, bmp_uint32_t depth);
/* TODO */
/* bmpfile_t *bmp_create_from_file(const char *filename); */
void bmp_destroy_mw(bmpfile_t *bmp);

bmp_header_t bmp_get_header_mw(bmpfile_t *bmp);
bmp_dib_v3_header_t bmp_get_dib_mw(bmpfile_t *bmp);

bmp_uint32_t bmp_get_width_mw(bmpfile_t *bmp);
bmp_uint32_t bmp_get_height_mw(bmpfile_t *bmp);
bmp_uint32_t bmp_get_depth_mw(bmpfile_t *bmp);

bmp_uint32_t bmp_get_dpi_x_mw(bmpfile_t *bmp);
bmp_uint32_t bmp_get_dpi_y_mw(bmpfile_t *bmp);
void bmp_set_dpi_mw(bmpfile_t *bmp, bmp_uint32_t x, bmp_uint32_t y);

rgb_pixel_t *bmp_get_pixel_mw(bmpfile_t *bmp, bmp_uint32_t x, bmp_uint32_t y);
int bmp_set_pixel_mw(bmpfile_t *bmp, bmp_uint32_t x, bmp_uint32_t y, rgb_pixel_t pixel);

int bmp_save_mw(bmpfile_t *bmp, const char *filename);
